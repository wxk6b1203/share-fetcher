...
CREATE TABLE IF NOT EXISTS stock_spot (
    ...
    turnover_rate DECIMAL(20, 2),
    pe_dynamic DECIMAL(20, 2),
    pb DECIMAL(20, 2),
    total_market_value DECIMAL(20, 2),
    circ_market_value DECIMAL(20, 2),
    speed_pct DECIMAL(20, 2),
    change_5min_pct DECIMAL(20, 2),
    change_60d_pct DECIMAL(20, 2),
    change_ytd_pct DECIMAL(20, 2),
